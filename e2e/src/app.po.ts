...
export class AppPage {
  ...
  getLoginLabel(): Promise<string> {
    return element(by.css('app-login div form h1')).getText() as Promise<string>;
  }
  ...
  getUserNameError(): Promise<string> { 
    ...
    el.sendKeys("ABC"); 
    var errorMsg = element(by.css('app-login div form')).all(by.className("alert alert-danger")).getText();
 ...
 //    payBtn.click(); 
   ...
   return payBtn.getText() as Promise<string>;
